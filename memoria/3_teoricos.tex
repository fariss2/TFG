...
\begin{itemize}
    ...
    \item \textbf{ First Primary Melanoma Risk Prediction Tool}: Desarrollada por el Melanoma Institute Australia, esta herramienta en línea permite a los profesionales de la salud estimar el riesgo individual de desarrollar un primer melanoma invasivo. Basada en un modelo de predicción validado, facilita discusiones informadas sobre hábitos de protección solar y vigilancia cutánea.
\end{itemize}
