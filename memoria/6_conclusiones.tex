...
Uno de los principales desafíos de este proyecto fue la obtención y homogeneización de datos ambientales fiables a nivel provincial, en particular los valores del índice de radiación ultravioleta (UV) y temperaturas en tiempo real.  Desde el punto de vista técnico, se logró desarrollar una aplicación web completamente funcional con el \textit{framework Shiny}, integrando múltiples fuentes de datos abiertos, cuyos dators fueron limpiados, procesados y adaptados para su visualización en mapas interactivos. La implementación de módulos específicos para el cálculo de riesgo, la recomendación personalizada y la consulta de históricos climáticos permitió abordar el problema desde una perspectiva integral en un contexto de salud pública.
...
En conjunto, los resultados alcanzados demuestran la viabilidad técnica y el valor divulgativo de la plataforma \textit{UV-Derma} como herramienta de apoyo a la prevención del melanoma cutáneo, con potencial de mejora y escalabilidad en el futuro.
