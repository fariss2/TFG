...
\begin{itemize}
    \item El propósito principal es informar y concienciar sobre el impacto de variables ambientales en el desarrollo del \textit{melanoma} maligno de piel, así como proporcionar una herramienta interactiva que visualice factores de riesgo asociados a esta patología en el contexto geográfico español.
\end{itemize}
